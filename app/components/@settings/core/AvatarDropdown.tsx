...
const BetaLabel = () => (
  <span className="px-1.5 py-0.5 rounded-full bg-green-500/10 dark:bg-green-500/20 text-[10px] font-medium text-green-600 dark:text-green-400 ml-2">
    BETA
  </span>
);
    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          >
            <div className="i-ph:user-circle w-4 h-4 text-gray-400 group-hover:text-green-500 dark:group-hover:text-green-400 transition-colors" />
            Edit Profile
          </DropdownMenu.Item>
